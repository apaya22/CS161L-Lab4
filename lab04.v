...
module lab04 (
  ...
  assign opcode_temp = s9[31:26];
  assign src1_addr_temp = s9[25:21];
  assign src2_addr_temp = s9[20:16];
  assign s1 = s9[15:11];
  assign s0 = s9[15:0];
  assign s7 = aluResult[7:0];
  // control_unit
  ...
  assign s4 = (Branch & ALU0);
  assign s6[31:2] = imm[31:2];
  assign s6[1:0] = 2'b0;
  assign PC = PC_temp;
